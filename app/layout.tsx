...
export const metadata: Metadata = {
  ...
  description: "中古PC・スマートフォン・タブレットならAI Across ショップ！全商品90日間動作保証・送料無料。法人・学校・官公庁のご注文も対応。最安値保証で安心購入。",
  ...
  openGraph: {
    ...
    description: "中古PC・スマートフォン・タブレットならAI Across ショップ！全商品90日間動作保証・送料無料。",
