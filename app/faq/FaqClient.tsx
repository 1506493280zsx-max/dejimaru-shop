...
const FAQS = [
  {cat:"注文について",items:[
    ...
    {q:"注文確認メールが届きません",a:"迷惑メールフォルダをご確認ください。Hotmail・Outlook・iCloudメールをご利用の場合、届かない場合がございます。"},
  ...
  {cat:"配送について",items:[
    {q:"送料はいくらですか？",a:"全国一律無料です（沖縄・一部離島を除く）。"},
    {q:"いつ届きますか？",a:"平日14時までのご注文は当日出荷いたします。出荷翌日〜3営業日程度でお届けします。"},
    {q:"時間指定はできますか？",a:"午前中・14〜16時・16〜18時・18〜20時・19〜21時からご指定いただけます。"},
  ]},
  {cat:"商品・保証について",items:[
    {q:"中古品のグレードとは何ですか？",a:"グレードNEW（新品）：未開封・未使用。グレードS（S品）：新品とほぼ同じ状態・目立つ使用痕跡なし。グレードA（A品）：軽微な使用痕跡あり。グレードB（B品）：使用痕跡が比較的目立つ。グレードC（C品）：訳あり品・研究や部品取り向け。"},
    {q:"保証期間はどのくらいですか？",a:"商品到着後30日間の初期不良保証がございます。"},
    {q:"初期不良だった場合どうすればいいですか？",a:"商品到着後5日以内にメールにてご連絡ください。代替品の発送またはご返金にて対応いたします。"},
  ]},
];
